...
const studentProjects = [
  ...
  },
  {
    ...
    title: "VR 역사 체험관",
    description:
      "역사적 사건을 VR로 재현하는 체험 플랫폼 제작. 역사 지식 검증과 교육적 맥락을 제공해주실 선생님 필요.",
    tags: ["VR", "역사", "기술"],
    comments: 24,
    status: "진행중",
    author: "이민지",
  ...
  },
  {
    ...
    title: "도시 텃밭 설계 도구",
    description:
      "도시민이 효율적으로 텃밭을 설계할 수 있는 웹 툴 개발. 식물학 관련 자문 가능한 선생님 필요.",
    tags: ["생물", "소프트웨어", "커뮤니티"],
    comments: 15,
    status: "진행중",
    author: "최지은",
  ...
  },
  {
    ...
    description:
      "시를 분석하고 토론할 수 있는 상호작용형 웹 플랫폼. 문학(국어) 지도 가능한 선생님 찾습니다.",
    tags: ["문학", "웹", "교육"],
    comments: 21,
    status: "완료",
    author: "한민석",
  ...
  },
  {
    ...
    description:
      "학교 건물의 전력 사용을 모니터링하고 절약 제안을 제시하는 시스템. 물리/전기 관련 선생님 필요.",
    tags: ["에너지", "IoT", "환경"],
    comments: 12,
    status: "모집중",
    author: "오정민",
  ...
  },
  {
    ...
    title: "학생 심리 지원 챗봇",
    description:
      "심리 검사 기반의 지원 챗봇 개발. 심리학 또는 상담 관련 자문 가능한 선생님을 찾고 있습니다.",
    tags: ["심리", "챗봇", "복지"],
    comments: 30,
    status: "진행중",
    author: "권태우",
  ...
  },
  {
    ...
    description:
      "버려지는 전자부품을 활용해 예술/실용품을 만드는 커뮤니티 프로젝트. 기술 지도 가능 선생님 환영.",
    tags: ["공학", "업사이클", "커뮤니티"],
    comments: 7,
    status: "모집중",
    author: "심지우",
  ...
  },
  {
    ...
    description:
      "초중학생 대상의 코딩 입문 강의 플랫폼. 수업 커리큘럼 검토 가능한 선생님을 찾습니다.",
    tags: ["교육", "웹", "코딩"],
    comments: 19,
    status: "완료",
    author: "이서윤",
  ...
  },
  {
    ...
    description:
      "지역별 데이터를 종합해 재난 발생 시 대응 우선순위를 시각화하는 도구. 지리/사회 관련 자문자 필요.",
    tags: ["데이터", "사회", "GIS"],
    comments: 5,
    status: "진행중",
    author: "백승호",
  ...
  },
  {
    ...
    description:
      "노래 가사 기반으로 외국어를 익히는 모바일 앱. 언어 교육 교사와 협업 희망.",
    tags: ["음악", "언어", "모바일"],
    comments: 14,
    status: "모집중",
    author: "정예린",
...
export default function StudentIdeasPage() {
  ...
  const groupedProjects = statusOrder.map((status) =>
    sortProjects(studentProjects.filter((p) => p.status === status))
  );
        ...
        <header className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              선생님과 협업을 원하는 학생들이 올린 프로젝트 아이디어를
              둘러보세요
            </p>
          </div>
