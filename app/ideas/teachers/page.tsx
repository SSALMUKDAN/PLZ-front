...
const teacherIdeas = [
  ...
  },
  {
    ...
    description:
      "지역 박물관과 협력해 현장학습 및 기록물을 활용한 프로젝트형 수업을 만들고자 합니다.",
    tags: ["역사", "현장학습", "교육"],
    comments: 8,
    status: "진행중",
    author: "정민우 선생님",
  ...
  },
  {
    ...
    title: "수학적 사고력 향상 캠프",
    description:
      "문제 해결 중심의 집중 캠프를 운영하려 합니다. 교재 및 활동 설계에 참여하실 분 찾습니다.",
    tags: ["수학", "교육", "워크숍"],
    comments: 3,
    status: "완료",
    author: "이수진 선생님",
  ...
  },
  {
    ...
    description:
      "초·중학생 대상의 코딩 보충 수업 커리큘럼을 공동 제작하고 싶습니다. 교수법 관련 자문 환영.",
    tags: ["코딩", "교육", "커리큘럼"],
    comments: 14,
    status: "모집중",
    author: "김태호 선생님",
  ...
  },
  {
    ...
    title: "학교 에너지 절감 캠페인",
    description:
      "학생들과 함께 학교 내 에너지 사용 실태를 조사하고 절감 캠페인을 기획하려 합니다.",
    tags: ["환경", "조사", "캠페인"],
    comments: 6,
    status: "진행중",
    author: "박혜정 선생님",
  ...
  },
  {
    ...
    description:
      "학생 작품을 지역 카페/공간에 전시하는 프로젝트를 기획합니다. 전시 기획/운영 경험 있으신 분 모집.",
    tags: ["미술", "커뮤니티", "전시"],
    comments: 11,
    status: "모집중",
    author: "송지나 선생님",
  ...
  },
  {
    ...
    description:
      "간단하고 안전한 실험 키트를 만들어 학교 내의 작은 과학 박람회에서 사용하고자 합니다.",
    tags: ["과학", "공학", "프로덕트"],
    comments: 9,
    status: "진행중",
    author: "오세훈 선생님",
  ...
  },
  {
    ...
    description:
      "다양한 장르의 책을 읽고 토론하는 프로그램을 운영합니다. 도서 선정 및 토론 가이드 제작 도움 필요.",
    tags: ["문학", "토론", "교육"],
    comments: 4,
    status: "완료",
    author: "김유리 선생님",
  ...
  },
  {
    ...
    title: "음악기 제작 워크숍",
    description:
      "재활용 재료로 간단한 악기를 만들어 보는 워크숍을 진행하려 합니다. 음악 수업 보조 가능하신 분 환영.",
    tags: ["음악", "공작", "교육"],
    comments: 7,
    status: "모집중",
    author: "최민석 선생님",
  ...
  },
  {
    ...
    description:
      "실험 안전 및 생활 속 화학 지식을 쉽게 전달할 수 있는 교육 자료를 제작하고자 합니다.",
    tags: ["화학", "안전", "교육자료"],
    comments: 2,
    status: "완료",
    author: "윤서영 선생님",
  ...
  },
  {
    ...
    description:
      "다양한 직업군의 멘토를 초청하어 멘토링과 직업 체험 기회를 제공하고자 합니다.",
    tags: ["진로", "멘토링", "커리어"],
    comments: 13,
    status: "진행중",
    author: "한상우 선생님",
  ...
  },
  {
    ...
    description:
      "디지털 시민성, 정보 검색 및 미디어 리터러시를 강화하는 수업 설계를 함께합니다.",
    tags: ["디지털", "미디어", "교육"],
    comments: 16,
    status: "모집중",
    author: "백지현 선생님",
